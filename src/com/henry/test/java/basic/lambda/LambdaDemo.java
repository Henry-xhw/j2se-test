package com.henry.test.java.basic.lambda;
...
//        void test(String str);
    ...
    static class MyStream2<T> {
        private List<T> list;
        public MyStream2(List<T> list) {
            this.list = list;

        }
        public void myForEach(ConsumerInterface2 consumerInterface2) {
            for (T t : list) {
                consumerInterface2.accept2(t);
            }
        }
    }
